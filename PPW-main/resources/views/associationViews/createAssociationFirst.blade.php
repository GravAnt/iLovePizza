...
<div class="Form">
    <form method="post" action="/createAssociation/second">
        @csrf
        <input id= "associationName"name="associationName" placeholder="Nome della nuova associazione" required> <br>
        <input id="number"type="number" min="1" max="5" name="pizzaTypesNumber" placeholder="Numero di categorie trattate" required> <br>
