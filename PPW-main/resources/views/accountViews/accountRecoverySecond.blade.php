...
<div class="Form">
    ...
    <form id="loginForm" method="POST" action="/accountRecovery">
        @csrf
        <h3 id="formTitle">RECUPERO ACCOUNT</h3>
        <b><p style="color: red; font-size:150%;">Credenziali non valide</p></b> <br>
    ...
    @else
    <h2>È stata inviata una mail all'indirizzo fornito</h2>
    @endif
</div>
